<template>
  <div class="flex">
    ...
    <div class="flex flex-col w-64 h-screen px-4 py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600">
        <h2 class="text-3xl font-semibold text-gray-800 dark:text-white italic">Paz</h2>
        ...
        <div class="flex flex-col justify-between flex-1 mt-6">
            ...
            <div class="flex items-center px-4 -mx-2">
                <img class="object-cover mx-2 rounded-full h-9 w-9" src="https://instagram.fmnl4-1.fna.fbcdn.net/v/t51.2885-19/s320x320/129722510_405579917458867_4219801792289654161_n.jpg?tp=1&_nc_ht=instagram.fmnl4-1.fna.fbcdn.net&_nc_ohc=tFQz57FoDQcAX9iNKek&ccb=7-4&oh=ad74bd57893a491523b0304d1e601bf9&oe=608871BD&_nc_sid=7bff83" alt="pazAvatar">
                <h4 class="mx-2 font-medium text-gray-800 dark:text-gray-200 hover:underline">Paz Christine Cacho</h4>
            </div>
        </div>
    </div>
      ...
      <div class="w-full bg-yellow-500">
        ...
        <div class="container px-6 py-3 mx-auto md:flex">
            <div class="flex items-center justify-between">
                <div>
                    <a class="text-xl italic font-bold text-gray-800 dark:text-white md:text-2xl hover:text-gray-700 dark:hover:text-gray-300" href="#">Paz</a>
                </div>
